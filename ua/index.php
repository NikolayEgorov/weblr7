...
<nav>
    <ul class="menu">
        ...
        <li class="menu-item"><a href="questions.html">Опитування</a></li>
        <li class="menu-item"><a href="contact-as.php">Залишити відгук</a></li>
...
<section id="leader">
    <div class="container">
        <img id="leader-photo" src="assets/img/Juschenko-1.jpeg" alt="Juschenko">
...
<footer>
    <ul>
        ...
        <li class="footer-item"><a href="questions.html">Опитування</a></li>
    </ul>
</footer>
